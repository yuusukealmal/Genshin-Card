...
const HEADERS = {
  'User-Agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) miHoYoBBS/2.40.1',
            ...
            http({
              ...
              .then(resp => {
                ...
                if (resp.retcode === 0) {
                  ...
                  logger.error('获取角色详情接口报错 %s', JSON.stringify(resp))
                  reject(resp.message)
                }
              })
              .catch(err => {
